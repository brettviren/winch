...
#+end_example
This command takes 17m and failed with 504 gateway timeout error.  Simply repushing gets it done.
Replace ~push~ with ~pull~ to get this image on to your podman.
